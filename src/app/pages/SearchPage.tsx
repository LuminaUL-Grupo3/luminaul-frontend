...
import { filterFeed } from '../components/PostController';
import { getCourses } from '../components/CourseController';
import { formatTimeAgo } from '../../utils/formatTimeAgo';
import type { PostFeedResponse, PostType } from '../components/PostService';
...
export function SearchPage() {
  ...
  // Feed filtrado: la vista llama al controlador (filterFeed) -> servicio -> GET /posts.
  // type/course_id/cycle van al servidor; el texto libre se refina en cliente.
  const [feed, setFeed] = useState<PostFeedResponse[]>([]);
  ...
  const posts = useMemo(() => {
    ...
    return feed
      ...
      .map((p) => ({
        ...
        authorAvatar: p.author.profile_photo_url,
